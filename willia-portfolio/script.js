...
const resolveViewByTarget = (targetId) => {
  ...
  if (
    [
      ...
      "appendix-f", "appendix-g", "appendix-h", "appendix-i", "appendix-j", "appendix-k", "appendix-l",
  ...
  const appendixImageMap = [
    {
      ...
      files: ["willia-appendix-a-1.png", "willia-appendix-a-2.png"]
    },
    ...
    { appendix: "Appendix E", title: "Medical Certificate", files: ["image29.png", "image30.png"] },
    { appendix: "Appendix F", title: "Certificate of Good Moral Character", files: [] },
    {
      appendix: "Appendix G",
      title: "Application Letter",
      contentType: "letter",
      signatureImage: "assets/images/appendix-signature.png",
      letterData: {
        ...
        body: [
          "Greetings of peace!",
          "I am writing to express my interest in applying as an On-the-Job Trainee in the Office of the Scholarship Program. I am currently a fourth-year student taking up Bachelor of Science in Information Technology at Occidental Mindoro State College - San Jose Campus.",
          "As a student who is eager to support both my academic journey and personal development, I believe that serving as an On-the-Job Trainee will help me gain valuable experience, enhance my skills, and at the same time be of service to the institution. I am confident in my ability to perform clerical tasks, handle documents, and assist with basic office functions responsibly and professionally.",
          "I am hoping for your kind consideration of my application. Thank you very much, and I look forward to the opportunity to contribute to your office."
        ],
        closing: "Respectfully yours,",
        name: "WILLIA MAE N. PERALTA",
        role: "Student-Applicant"
      }
    },
    { appendix: "Appendix H", title: "Endorsement Letter", files: ["willia-appendix-h-endorsement.png"] },
    { appendix: "Appendix I", title: "Memorandum of Agreement", files: [] },
    { appendix: "Appendix J", title: "Daily Time Record (Time Card)", files: [] },
    { appendix: "Appendix K", title: "Certificate of Completion (Placement Agency/Office)", files: ["willia-appendix-k-completion.png"] },
    { appendix: "Appendix L", title: "Certificate of Clearance (Placement Agency/Office)", files: ["willia-appendix-l-clearance.png"] },
    { appendix: "Appendix M", title: "Performance/Proficiency Rating Sheet (Placement Agency/Office)", files: ["willia-appendix-m-eval-1.png", "willia-appendix-m-eval-2.png", "willia-appendix-m-eval-3.png"] },
    { appendix: "Appendix N", title: "Pictures during Pre-service Seminar", files: ["image36.jpeg", "image37.jpeg", "image38.jpeg", "image39.jpeg", "image40.jpeg", "image41.jpeg"] },
    { appendix: "Appendix O", title: "Pictures during Office Works", files: ["image42.jpeg", "image43.jpeg", "image44.jpeg", "image45.jpeg", "image46.jpeg", "image47.jpeg", "image48.jpeg", "image49.jpeg", "image50.jpeg"] },
    {
      appendix: "Appendix P",
    ...
    },
    {
      ...
      contentType: "cv",
      photo: "appendix-q-photo.png",
      signatureImage: "assets/images/appendix-signature.png",
      cvData: {
        name: "WILLIA MAE N. PERALTA",
        address: "Bagong Sikat, San Jose, Occidental Mindoro",
        email: "williaperalta.bsit@gmail.com",
        phone: "09670554104",
        objective: "To enhance and obtain a position that will enable me to use my skills, educational background, and ability to work with people.",
        education: [
          {
            level: "Tertiary:",
          ...
          {
            level: "Primary:",
            school: "Bagong Sikat Elementary School",
            details: "",
            period: "(2010-2016)"
          }
        ],
        ...
        personalData: [
          ...
          "Father's Name: Wilfredo Peralta",
          "Mother's Name: Melinda Peralta"
        ],
        characterReferences: [
          "Name:",
          "Position:",
        ...
        ,
        declarationName: "WILLIA MAE N. PERALTA",
    ...
    },
    {
      ...
      formData: {
        studentName: "Peralta, Willia Mae N.",
        course: "BSIT 4C",
  ...
  appendixImageMap.forEach((group) => {
    ...
    if (group.contentType === "letter") {
      ...
      if (group.photo) {
        ...
        photo.src = `${imageBasePath}${group.photo}`;
      ...
      if (group.headerImage) {
        ...
        img.src = `${imageBasePath}${group.headerImage}`;
